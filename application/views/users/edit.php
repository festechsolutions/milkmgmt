          ...
          <div class="box">
            ...
            <form role="form" action="<?php base_url('users/create') ?>" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="groups">Colony</label>
                  <select class="form-control" id="store" name="store">
                    <option value="">Select Store/Colony Name</option>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="username" name="username" placeholder="Username" value="<?php echo $user_data['username'] ?>" autocomplete="off" readonly="true">
                </div>
