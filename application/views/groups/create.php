                  ...
                  <table class="table table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><input type="checkbox" name="permission[]" id="permission" value="updateProProduct"></td>
                      ...
                      <tr>
                        <td>Subscription</td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="createSubscription"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="updateSubscription"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewSubscription"></td>
