	...
	public function fetchProductData()
	{
		...
		foreach ($data as $key => $value) {
            ...
            if(in_array('updateProduct', $this->permission)) {
    			$buttons .= '<a href="'.base_url('products/update/'.$value['id']).'" style="border: 2px solid #4CAF50" class="btn btn-default"><i class="fa fa-pencil" style="color:#4CAF50"></i></a>';
            }
            ...
            $category_name =  $this->model_category->getCategoryData($category_id);
